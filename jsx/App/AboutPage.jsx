...
export function AboutPage() {
  return (
		<div style={{margin: "0.5in"}}>
			...
			<p>In addition to being available on this via the “Textos” tab at the top, primary language materials are also archived at the California Language Archive at UC Berkeley and the Endangered Languages Archive at SOAS.</p>
			<h3>Members</h3>
			<h4>Co-directors</h4>
